...
public:
    /**
     * Data has two extra rows in each process
     * that will be used as buffers for communication with neighbors.
     * data[color][0] is the buffer for communication with the top neighbor.
     * data[color][]
     */
    double **data[2];
